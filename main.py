...
# Kelompok 8:
# Setyo Aji (1301208603)
# Annisa Humairo (1301208348)
# Teguh Surya Apri H. (1301194305)
# Akmal Ikhsan (1301184059)
...
# Function untuk membuat source yang akan digunakan dalam plotting graph
...
# Function untuk membuat plot graph berdasarkan data dari function create_source
...
# Function untuk mengupdate data graph ketika bagian input di edit
...
div = Div(sizing_mode='stretch_width', height=500)
